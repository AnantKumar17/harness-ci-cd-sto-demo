# Harness CI/CD + STO Pipeline Demo

A complete demonstration of **Harness Continuous Delivery** with integrated security scanning, deployed to Kubernetes on minikube.
